...
shape_names = ["square", "circle", "triange", "star", "hexagon", "rhombus", "diamond", "bowtie"] #corresponding names
...
def user_decision(user_choice): # takes the users inputs as param for if structure
    random_num = r.randint(1,6)
    li = [""] * random_num
    if user_choice.upper() == "Y": # random shapes
        for i in range(random_num): # generate 1 to 5 random shapes
